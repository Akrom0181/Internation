...
const (
	...
	GroupService_GetByIDTeacher_FullMethodName = "/schedule_service.GroupService/GetByIDTeacher"
...
type GroupServiceClient interface {
	...
	GetByIDTeacher(ctx context.Context, in *TeacherID, opts ...grpc.CallOption) (*GetGroup, error)
	...
	Delete(ctx context.Context, in *GroupPrimaryKey, opts ...grpc.CallOption) (*EmptyGroup, error)
}
...
func (c *groupServiceClient) GetByIDTeacher(ctx context.Context, in *TeacherID, opts ...grpc.CallOption) (*GetGroup, error) {
	out := new(GetGroup)
...
func (c *groupServiceClient) Delete(ctx context.Context, in *GroupPrimaryKey, opts ...grpc.CallOption) (*EmptyGroup, error) {
	out := new(EmptyGroup)
...
func (UnimplementedGroupServiceServer) GetByIDTeacher(context.Context, *TeacherID) (*GetGroup, error) {
...
func (UnimplementedGroupServiceServer) Delete(context.Context, *GroupPrimaryKey) (*EmptyGroup, error) {
