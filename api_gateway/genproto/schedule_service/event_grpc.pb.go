...
type EventServiceClient interface {
	...
	Delete(ctx context.Context, in *EventPrimaryKey, opts ...grpc.CallOption) (*EmptyEvent, error)
}
...
func (c *eventServiceClient) Delete(ctx context.Context, in *EventPrimaryKey, opts ...grpc.CallOption) (*EmptyEvent, error) {
	out := new(EmptyEvent)
...
type EventServiceServer interface {
	...
	Delete(context.Context, *EventPrimaryKey) (*EmptyEvent, error)
}
...
func (UnimplementedEventServiceServer) Delete(context.Context, *EventPrimaryKey) (*EmptyEvent, error) {
