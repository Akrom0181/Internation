...
type TeacherServiceClient interface {
	...
	Delete(ctx context.Context, in *TeacherPrimaryKey, opts ...grpc.CallOption) (*EmptyTeacher, error)
...
func (c *teacherServiceClient) Delete(ctx context.Context, in *TeacherPrimaryKey, opts ...grpc.CallOption) (*EmptyTeacher, error) {
	out := new(EmptyTeacher)
...
type TeacherServiceServer interface {
	...
	Delete(context.Context, *TeacherPrimaryKey) (*EmptyTeacher, error)
...
func (UnimplementedTeacherServiceServer) Delete(context.Context, *TeacherPrimaryKey) (*EmptyTeacher, error) {
