...
type BranchServiceClient interface {
	...
	Delete(ctx context.Context, in *BranchPrimaryKey, opts ...grpc.CallOption) (*EmptyBranch, error)
}
...
func (c *branchServiceClient) Delete(ctx context.Context, in *BranchPrimaryKey, opts ...grpc.CallOption) (*EmptyBranch, error) {
	out := new(EmptyBranch)
...
type BranchServiceServer interface {
	...
	Delete(context.Context, *BranchPrimaryKey) (*EmptyBranch, error)
}
...
func (UnimplementedBranchServiceServer) Delete(context.Context, *BranchPrimaryKey) (*EmptyBranch, error) {
