...
func Load() Config {
	...
	config.ScheduleServiceHost = cast.ToString(getOrReturnDefaultValue("USER_SERVICE_HOST", "localhost"))
	config.ScheduleServicePort = cast.ToString(getOrReturnDefaultValue("USER_SEVICE_PORT", ":8081"))
