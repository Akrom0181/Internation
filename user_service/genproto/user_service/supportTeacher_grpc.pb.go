...
type SupportTeacherServiceClient interface {
	...
	Delete(ctx context.Context, in *SupportTeacherPrimaryKey, opts ...grpc.CallOption) (*EmptySTeacher, error)
...
func (c *supportTeacherServiceClient) Delete(ctx context.Context, in *SupportTeacherPrimaryKey, opts ...grpc.CallOption) (*EmptySTeacher, error) {
	out := new(EmptySTeacher)
...
type SupportTeacherServiceServer interface {
	...
	Delete(context.Context, *SupportTeacherPrimaryKey) (*EmptySTeacher, error)
...
func (UnimplementedSupportTeacherServiceServer) Delete(context.Context, *SupportTeacherPrimaryKey) (*EmptySTeacher, error) {
