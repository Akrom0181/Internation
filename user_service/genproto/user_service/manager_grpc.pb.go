...
type ManagerServiceClient interface {
	...
	Delete(ctx context.Context, in *ManagerPrimaryKey, opts ...grpc.CallOption) (*EmptyManager, error)
}
...
func (c *managerServiceClient) Delete(ctx context.Context, in *ManagerPrimaryKey, opts ...grpc.CallOption) (*EmptyManager, error) {
	out := new(EmptyManager)
...
type ManagerServiceServer interface {
	...
	Delete(context.Context, *ManagerPrimaryKey) (*EmptyManager, error)
}
...
func (UnimplementedManagerServiceServer) Delete(context.Context, *ManagerPrimaryKey) (*EmptyManager, error) {
